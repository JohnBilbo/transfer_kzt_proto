...
func (c *transferKZTServiceClient) Transfer(ctx context.Context, in *RequestTransfer, opts ...grpc.CallOption) (*ResponseTransfer, error) {
	...
	err := c.cc.Invoke(ctx, TransferKZTService_Transfer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferKZTServiceClient) CreateTransfer(ctx context.Context, in *RequestCreateTransfer, opts ...grpc.CallOption) (*ResponseCreateTransfer, error) {
	...
	err := c.cc.Invoke(ctx, TransferKZTService_CreateTransfer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTransferKZTServiceServer must be embedded to have forward compatible implementations.
